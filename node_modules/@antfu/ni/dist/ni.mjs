import { a as __toESM, i as __require, t as __commonJSMin } from "./rolldown-runtime-DPI6AWJA.mjs";
import { A as require_prompts, T as formatPackageWithUrl, h as getCatalog, i as runCli, l as parseNi, o as getCommand, w as exclude } from "./src-Bz0vH9-F.mjs";
import fs from "node:fs";
import path from "node:path";
import process from "node:process";
import { styleText } from "node:util";
import { Fzf } from "fzf";
//#region node_modules/.pnpm/fast-npm-meta@2.1.0/node_modules/fast-npm-meta/dist/index.mjs
...
//#endregion
//#region node_modules/.pnpm/pnpm-workspace-yaml@1.6.1/node_modules/pnpm-workspace-yaml/dist/index.mjs
...
//#endregion
//#region src/catalog/yarn.ts
function findYarnRcYaml(cwd) {
	let dir = path.resolve(cwd);
	while (true) {
...
function getCatalogProvider(agent) {
	...
	if (agent === "yarn@berry") return yarnCatalogProvider;
	return null;
}
//#endregion
